...
- Ability to manipulate a web browser."><pre class="notranslate"><code>Prerequisites: 
- Understand HTML. 
- Understand the HTTP protocol. 
...
- Knowledge of a scripting language."><pre class="notranslate"><code>Prerequisites: 
- Knowledge of most common encoding formats.
- Knowledge of most common hash algorithms and ciphers.
